...
class Snowflake():
    ...
    def __init__(self, snowflakeID: int | str, configuration: SnowfallConfig = SnowfallConfig()) -> None: 
        """
    ...
    def _decodeSnowflake(self, snowflake: int) -> None:
        ...
        self.MachineID = (snowflake >> SnowfallConfig.MACHINE_SEQUENCE_BITS) & self._maskGenerator
