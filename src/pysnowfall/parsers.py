...
def toSnowflakeCustom(snowflakeID: str | int, configuration: SnowfallConfig) -> Snowflake:
    """
...
def toSnowflake(snowflakeID: str | int, useGlobalConfiguration: bool = True) -> Snowflake:
    """
